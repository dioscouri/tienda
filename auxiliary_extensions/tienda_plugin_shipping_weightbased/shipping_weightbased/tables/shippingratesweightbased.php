...
class TiendaTableShippingRatesWeightbased extends TiendaTable
{
	function TiendaTableShippingRatesWeightbased ( &$db )
	{
		$tbl_key    = 'shipping_rate_weightbased_id';
		$tbl_suffix = 'shippingrates_weightbased';
