...
<form enctype="multipart/form-data" name="adminForm" method="post" action="index.php?option=com_tienda&task=doTask&element=generic_exporter&elementTask=viewcolumns">
	<table class="adminlist">
		<tbody>
			<tr>
				<th style="width: 25%;">
					<?php echo JText::_('Model/Table')?>
				</th>
				<td>
					<?php $list = array();?>
