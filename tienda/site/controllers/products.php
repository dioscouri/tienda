			...
			if ( $product->quantity_restriction )
			{
				...
				if ( $max )
				{
					...
					if ( $product_qty > $remaining )
					{
						...
						$msg = $helper
								->generateMessage( 
										JText::_( "You have reached the maximum quantity for this item. You can order another" ) . " " . $remaining );
					}
				}
				if ( $min )
				{
					if ( $product_qty < $min )
					{
						...
						$msg = $helper
								->generateMessage( 
										JText::_( "You have not reached the miminum quantity for this item. You have to order at least" ) . " "
												. $min );
					}
				}
			}
