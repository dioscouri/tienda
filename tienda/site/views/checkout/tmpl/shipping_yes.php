...
<?php
        ...
        else
    {
        ...
        <input type="button" class="btn" value="<?php echo JText::_( "COM_TIENDA_GET_SHIPPING_RATES" ); ?>" onclick="tiendaGetShippingRates( 'onCheckoutShipping_wrapper', document.adminForm );">
        <?php
    }
?>
<?php $setval = false;?>
