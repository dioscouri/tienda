            ...
            <td style="text-align: left;">
              ...
              <div id="shippingAddress">
                ...
                {	                $shipattribs = array(
	                   'class' => 'inputbox',    
	                   'size' => '1',
	                   'onchange' => "tiendaGrayOutAddressDiv('".JText::_( "COM_TIENDA_UPDATING_ADDRESS" )."');tiendaDoTask('$baseurl'+this.options[this.selectedIndex].value, 'shippingDefaultAddress', '', '', false); tiendaGetShippingRates( 'onCheckoutShipping_wrapper', document.adminForm, '".JText::_( "COM_TIENDA_UPDATING_SHIPPING_RATES" )."', '".JText::_( "COM_TIENDA_UPDATING_CART" )."', tiendaDeleteCombinedGrayDiv ); "
