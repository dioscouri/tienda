...
$display_fb = Tienda::getInstance( )->get( 'display_facebook_like', '1' );
$display_tw = Tienda::getInstance( )->get( 'display_tweet', '1' );
$display_gp = Tienda::getInstance( )->get( 'display_google_plus1', '1' );
?>
...
<div class="product_like">
	...
	<?php if ( $display_gp ) : ?>
	<?php $google_plus1_size = Tienda::getInstance( )->get( 'display_google_plus1_size', 'medium' ); ?>
