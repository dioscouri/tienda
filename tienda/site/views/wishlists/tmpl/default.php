...
<?php foreach($wishlists as $item) : ?>
	...
	<li class="<?php if($item->active) { echo 'active';} ?>"><a href="<?php echo $item->link; ?>"><?php echo $item->name; ?></a></li>
...
<div class="span8">
	<div class='componentheading'>
    <span><?php echo $this->active->name ?></span>
</div>
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_tienda&view=wishlists&task=update&Itemid='.$router->findItemid( array('view'=>'wishlists') ) ); ?>" method="post" name="adminForm" enctype="multipart/form-data">
            ...
            <tfoot>
                <tr>
                    <td colspan="20" style="text-align: left;">
                        <input type="hidden" value="<?php echo $this->wishlist->wishlist_id ?>" name="id" />
                        <input type="submit" class="btn" value="<?php echo JText::_('COM_TIENDA_ADD_TO_CART'); ?>" name="addtocart" />
                        <input type="submit" class="btn" value="<?php echo JText::_('COM_TIENDA_REMOVE'); ?>" name="remove" />
        ...
        <?php if (!empty($this->return)) { ?>
            <div style="float: left;">
                <a class="btn" href="<?php echo $this->return; ?>">
