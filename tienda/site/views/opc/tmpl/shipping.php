...
<form id="opc-shipping-form" name="opc-shipping-form" action="" method="post">
    ...
    <fieldset id="existing-shipping-addresses">
        <select id="existing-shipping-address" name="shipping_address_id">
            ...
            <?php } ?>
            <option id="create-new-shipping-address" value="0"><?php echo JText::_( "COM_TIENDA_NEW_ADDRESS" ); ?></option>
        </select>
    </fieldset>
    <?php } ?>
        ...
        <ul class="unstyled">
            <li class="control">
                <label for="<?php echo $this->form_prefix; ?>same_as_billing" class="checkbox">
                    <input type="checkbox" onclick="Opc.shipping.setSameAsBilling(this.checked)" title="<?php echo JText::_( "COM_TIENDA_USE_BILLING_ADDRESS" ); ?>" value="0" id="<?php echo $this->form_prefix; ?>same_as_billing" name="<?php echo $this->form_prefix; ?>same_as_billing">
    ...
    <a id="opc-shipping-button" class="btn btn-primary"><?php echo JText::_('COM_TIENDA_CONTINUE') ?></a>
