...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_geozonetypes` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_manufacturers` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_taxclasses` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__tienda_taxrates` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__tienda_categories` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_currencies` (
...
-- -----------------------------------------------------
-- Table `#__tienda_orderstates`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_orderstates` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_orders` (
...
-- -----------------------------------------------------
-- Table structure for table `#__tienda_productquantities`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__tienda_productquantities` (
...
-- -----------------------------------------------------
-- Table structure for table `#__tienda_productattributes`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table structure for table `#__tienda_productattributeoptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__tienda_productattributeoptions` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_products` (
...
-- --------------------------------------------------------
-- Table structure for table `#__tienda_orderitemattributes`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__tienda_orderitemattributes` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_orderitems` (
...
-- -----------------------------------------------------
-- Table structure for table `#__tienda_ordervendors`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `#__tienda_ordervendors` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_orderinfo` (
...
-- -----------------------------------------------------
-- Table `#__tienda_productcategoryxref`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_productcategoryxref` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__tienda_productprices` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__tienda_shippingrates` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_userinfo` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_addresses` (
...
CREATE TABLE IF NOT EXISTS `#__tienda_zones` (
...
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `#__tienda_zonerelations` (
...
-- --------------------------------------------------------
--
-- Table structure for table `#__tienda_wishlistitems`
--
-- --------------------------------------------------------
...
-- --------------------------------------------------------
--
-- Constraints for table `#__tienda_wishlistitems`
--
-- --------------------------------------------------------
ALTER TABLE `#__tienda_wishlistitems`
  ADD CONSTRAINT `fk_wishlists_products` FOREIGN KEY (`product_id`) REFERENCES `#__tienda_products` (`product_id`) ON DELETE CASCADE;
