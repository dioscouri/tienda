...
--
DELETE FROM `#__tienda_categories` WHERE `#__tienda_categories`.`category_id` = 1 LIMIT 1;


--
-- Dumping data for Table `#__tienda_categories`
--
...
--
-- Dumping data for Table `#__tienda_productprices`
--
INSERT IGNORE INTO `#__tienda_productprices` (`product_price_id`, `product_id`, `product_price`, `product_price_startdate`, `product_price_enddate`, `created_date`, `modified_date`, `group_id`, `price_quantity_start`, `price_quantity_end`) VALUES
