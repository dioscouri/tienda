...
-- -----------------------------------------------------
ALTER TABLE #__tienda_eavattributeentityxref DROP FOREIGN KEY `fk_EavAttribute_EavAttributes`;
ALTER TABLE #__tienda_eavattributeoptions DROP FOREIGN KEY `fk_eavattributeoptions_eavattribute`;
ALTER TABLE #__tienda_eavvaluesvarchar DROP FOREIGN KEY `fk_eavvaluesvarchar_eavattribute`;
ALTER TABLE #__tienda_eavvaluesint DROP FOREIGN KEY `fk_eavvaluesint_eavattribute`;
ALTER TABLE #__tienda_eavvaluestext DROP FOREIGN KEY `fk_eavvaluestext_eavattribute`;
ALTER TABLE #__tienda_eavvaluesdatetime DROP FOREIGN KEY `fk_eavvaluesdatetime_eavattribute`;
ALTER TABLE #__tienda_eavvaluesdecimal DROP FOREIGN KEY `fk_eavvaluesdecimal_eavattribute`;
...
ALTER TABLE #__tienda_productattributeoptionvalues DROP FOREIGN KEY `fk_paov_pao`;
...
ALTER TABLE #__tienda_usergroupxref DROP FOREIGN KEY `fk_Group_UserGroup`;
...
ALTER TABLE #__tienda_productcouponxref DROP FOREIGN KEY `fk_Product_ProductCoupon`;
ALTER TABLE #__tienda_productcouponxref DROP FOREIGN KEY `fk_Coupon_ProductCoupon`;
ALTER TABLE #__tienda_wishlists DROP FOREIGN KEY `fk_wishlists_products`;
...
alter table `#__tienda_coupons` ENGINE=MYISAM;
alter table `#__tienda_credits` ENGINE=MYISAM;
alter table `#__tienda_credittypes` ENGINE=MYISAM;
alter table `#__tienda_currencies` ENGINE=MYISAM;
alter table `#__tienda_eavattributeentityxref` ENGINE=MYISAM;
alter table `#__tienda_eavattributeoptions` ENGINE=MYISAM;
alter table `#__tienda_eavattributes` ENGINE=MYISAM;
alter table `#__tienda_eavvaluesdatetime` ENGINE=MYISAM;
alter table `#__tienda_eavvaluesdecimal` ENGINE=MYISAM;
alter table `#__tienda_eavvaluesint` ENGINE=MYISAM;
alter table `#__tienda_eavvaluestext` ENGINE=MYISAM;
alter table `#__tienda_eavvaluesvarchar` ENGINE=MYISAM;
alter table `#__tienda_geozones` ENGINE=MYISAM;
alter table `#__tienda_geozonetypes` ENGINE=MYISAM;
alter table `#__tienda_groups` ENGINE=MYISAM;
alter table `#__tienda_manufacturers` ENGINE=MYISAM;
alter table `#__tienda_ordercoupons` ENGINE=MYISAM;
...
alter table `#__tienda_productcomments` ENGINE=MYISAM;
alter table `#__tienda_productcommentshelpfulness` ENGINE=MYISAM;
alter table `#__tienda_productcompare` ENGINE=MYISAM;
alter table `#__tienda_productcouponxref` ENGINE=MYISAM;
...
alter table `#__tienda_productissues` ENGINE=MYISAM;
...
alter table `#__tienda_subscriptionhistory` ENGINE=MYISAM;
alter table `#__tienda_subscriptions` ENGINE=MYISAM;
...
alter table `#__tienda_wishlists` ENGINE=MYISAM;
