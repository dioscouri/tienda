 ...
 * @since 1.5
 */
class TiendaViewElementProductMultiple extends JView
{
	function display()
	{
...
<table class="adminlist" cellspacing="1">
	...
	for ($i=0, $n=count( $rows ); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td style="text-align: center;"><?php echo TiendaGrid::checkedout( $row, $i, 'product_id' ); ?>
			</td>
			...
			<?php
				...
				{
					?>
					<img src="<?php echo Tienda::getURL( 'products_thumbs').$row->product_thumb_image; ?>" style="display: block;" />
					<?php	
				}
			?>	
			</td>				
