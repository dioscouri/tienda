 ...
 * @since 1.5
 */
class TiendaViewElementArticle extends JView
{
	function display()
	{
		global $mainframe;
		...
		$link = 'index.php?option=com_tienda&task=elementArticle&tmpl=component&object='.$object;
		...
		<form action="<?php echo $link; ?>" method="post" name="adminForm">
			...
			<table>
				<tr>
					<td width="100%">
						<?php echo JText::_('COM_TIENDA_FILTER'); ?>:
