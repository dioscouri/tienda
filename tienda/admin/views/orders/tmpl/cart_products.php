...
<?php $items = (!empty($this->productsInCart)) ? $this->productsInCart : array(); ?>
                ...
                <tr class='row<?php echo $k; ?>'>
                    ...
                    <td style="text-align: left;">
	                    ...
	                    <?php if (!empty($item->product_sku)) : ?>
		                    ...
		                    <?php echo $item->produshict_sku; ?>
		                <?php endif; ?>
	                </td>
                    <td style="text-align: center; vertical-valign: top;">
                        <input name="quantity[<?php  echo $item->product_id; ?>]" value="<?php echo $item->product_qty; ?>" style="width: 30px;" type="text" />
                    </td>
