...
<div class="note_green" style="width: 96%; margin-left: auto; margin-right: auto;">
    ...
    <div style="float: right;">
        <button class="btn btn-success" onclick="document.adminForm.toggle.checked=true; checkAll(<?php echo count( @$items ); ?>); document.getElementById('task').value='savequantities'; document.adminForm.submit();"><?php echo JText::_('COM_TIENDA_SAVE_ALL_CHANGES'); ?></button>
    </div>
    <div class="reset"></div>
