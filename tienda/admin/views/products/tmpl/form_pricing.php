...
<div style="float: left; width: 50%;">
    <div class="well options">
        ...
        <table class="table table-striped table-bordered">
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_ITEM_FOR_SALE'); ?>
                </td>
                <td>
            ...
            if (empty($row->product_id) || empty($prices))
            {
                ...
                ?>
            <tr>
                <td width="100" align="right" class="dsc-key" style="vertical-align: top;"><label for="product_price"> <?php echo JText::_('COM_TIENDA_NORMAL_PRICE'); ?>:
                </label>
                </td>
            ...
            else
            {
                ...
                ?>
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><label for="product_prices"> <?php echo JText::_('COM_TIENDA_PRICES'); ?>:
                </label>
                </td>
                <td><?php
            ...
            ?>
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_TAX_CLASS'); ?>:</td>
                <td><?php echo TiendaSelect::taxclass( @$row->tax_class_id, 'tax_class_id', '', 'tax_class_id', false ); ?>
                </td>
            </tr>
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_CHECK_PRODUCT_INVENTORY'); ?>:</td>
            ...
            if (empty($row->product_check_inventory) && !empty($row->product_id))
            {
                ?>
            <tr>
                <td width="100" align="right" class="dsc-key" style="vertical-align: top;"><?php echo JText::_('COM_TIENDA_PRODUCT_QUANTITIES'); ?>:</td>
                <td>
                    <div class="note well">
            ...
            else
            {
                if (empty($row->product_id))
                {
                    ...
                    ?>
            <tr>
                <td width="100" align="right" class="dsc-key" style="vertical-align: top;"><?php echo JText::_('COM_TIENDA_STARTING_QUANTITY'); ?>:</td>
            ...
            <?php
                ...
                else
                {
                    ...
                    ?>
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_PRODUCT_QUANTITIES'); ?>:</td>
                <td><?php
            ...
            ?>
            <tr>
                <td title="<?php echo JText::_('COM_TIENDA_PURCHASE_QUANTITY_RESTRICTION').'::'.JText::_('COM_TIENDA_PURCHASE_QUANTITY_RESTRICTION_TIP'); ?>" style="width: 100px; text-align: right;" class="key hasTip"><?php echo JText::_('COM_TIENDA_PURCHASE_QUANTITY_RESTRICTION'); ?>:</td>
                <td>
                    <div class="control-group">
                        <div class="controls">
                            <fieldset id="product_enabled" class="radio btn-group">
                                <input type="radio" <?php if (empty($row->quantity_restriction)) { echo "checked='checked'"; } ?> value="0" name="quantity_restriction" id="quantity_restriction0" /><label onclick="tiendaShowHideDiv('quantity_restrictions');" for="quantity_restriction0"><?php echo JText::_('COM_TIENDA_NO'); ?> </label> <input type="radio" <?php if (!empty($row->quantity_restriction)) { echo "checked='checked'"; } ?> value="1" name="quantity_restriction" id="quantity_restriction1" /><label onclick="tiendaShowHideDiv('quantity_restrictions');" for="quantity_restriction1"><?php echo JText::_('COM_TIENDA_YES'); ?> </label>

                            </fieldset>
                        </div>
                    </div> <?php // Only display if quantity restriction ?>
                    <div id="quantity_restrictions" style=' <?php if (empty($row->quantity_restriction)) { echo "display: none;"; } ?>' >
                        <table class="table table-striped table-bordered" style="width: 100%;">
                            <tr>
                                <td style="width: 100px; text-align: right;" class="dsc-key"><label for="quantity_min"> <?php echo JText::_('COM_TIENDA_MINIMUM_QUANTITY'); ?>:
                                </label>
                                </td>
                            ...
                            <tr>
                                <td style="width: 100px; text-align: right;" class="dsc-key"><label for="quantity_max"> <?php echo JText::_('COM_TIENDA_MAXIUM_QUANTITY'); ?>:
                                </label>
                                </td>
                            ...
                            <tr>
                                <td style="width: 100px; text-align: right;" class="dsc-key"><label for="quantity_step"> <?php echo JText::_('COM_TIENDA_STEP_QUANTITY'); ?>:
                                </label>
                                </td>
            ...
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_HIDE_QUANTITY_INPUT_ON_PRODUCT_FORM'); ?>:</td>
                <td><?php  echo TiendaSelect::btbooleanlist( 'param_hide_quantity_input', '', @$row->product_parameters->get('hide_quantity_input') ); ?>
                </td>
            </tr>
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_DEFAULT_QUANTITY_IF_INPUT_HIDDEN_ON_PRODUCT_FORM'); ?>:</td>
            ...
            <tr>
                <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_DISABLE_ABILITY_TO_UPDATE_QUANTITY_IN_CART'); ?>:</td>
...
<div style="float: left; width: 50%;">
    <div class="well options">
        ...
        <table class="table table-striped table-bordered">
            <tr>
                <td title="<?php echo JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE').'::'.JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE_TIP'); ?>" style="width: 100px; text-align: right;" class="key hasTip"><?php echo JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE'); ?>:</td>
                <td><?php  echo TiendaSelect::btbooleanlist( 'product_listprice_enabled', '', @$row->product_listprice_enabled ); ?>
                </td>
            </tr>
            <tr>
                <td title="<?php echo JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE').'::'.JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE_TIP'); ?>" style="width: 100px; text-align: right;" class="key hasTip"><?php echo JText::_('COM_TIENDA_DISPLAY_PRODUCT_LIST_PRICE'); ?>
                </td>
