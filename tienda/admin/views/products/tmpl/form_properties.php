    ...
    <tr>
        <td style="vertical-align: top; width: 65%;">
            ...
            <div class="well options">
                <legend>
                    <?php echo JText::_('COM_TIENDA_ADDITIONAL_INFORMATION'); ?>
                </legend>
                ...
                <div style='width: 100%;'>
                    <table class="table table-striped table-bordered" style="width: 100%;">
                        ...
                        if (empty($row->product_id))
                        {
                            ...
                            ?>
                        <tr>
                            <td width="100" align="right" class="dsc-key" style="vertical-align: top;"><?php echo JText::_('COM_TIENDA_PRODUCT_ATTRIBUTES'); ?>:</td>
                            <td class="dsc-value">
                                <div class="note well">
            ...
            <div class="well options">
                <legend>
                    <?php echo JText::_('COM_TIENDA_PUBLICATION_DATES'); ?>
                </legend>
                <table class="table table-striped table-bordered" style="width: 100%;">
                    <tr>
                        <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_PUBLISH_UP'); ?>:</td>
                        <td><?php echo JHTML::calendar( @$row->publish_date, "publish_date", "publish_date", '%Y-%m-%d %H:%M:%S', array('size'=>25) ); ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px; text-align: right;" class="dsc-key"><?php echo JText::_('COM_TIENDA_PUBLISH_DOWN'); ?>:</td>
            ...
            <div class="well options">
                ...
                <table class="table table-striped table-bordered" style="width: 100%;">
                    ...
                    if (empty($row->product_id))
                    {
                        ...
                        ?>
                    <tr>
                        <td width="100" align="right" class="dsc-key" style="vertical-align: top;"><label for="category_id"> <?php echo JText::_('COM_TIENDA_PRODUCT_CATEGORY'); ?>:
                        </label>
                        </td>
                    ...
                    else
                    {
                        ...
                        ?>
                    <tr>
                        <td style="width: 100px; text-align: right;" class="dsc-key"><label for="product_categories"> <?php echo JText::_('COM_TIENDA_CATEGORIES'); ?>:
                        </label>
                        </td>
