...
<form action="<?php echo JRoute::_( @$form['action'] ) ?>" method="post" class="adminform" name="adminForm" >
    ...
    <legend><?php echo JText::_('COM_TIENDA_BASIC_INFORMATION'); ?></legend>
			...
			if(version_compare(JVERSION,'1.6.0','ge')) {
			//I had to add a new XML file because the plugin XML for some reason fails to load.  try to fix this later to only need one. 	
			...
			$registry->loadString('{"merchant_email":"chris@chris.com","currency":"USD2","secure_post":"0","img_url_std":"https:\/\/www.paypal.com\/en_US\/i\/btn\/x-click-but20.gif","img_url_mixed":"https:\/\/www.paypal.com\/en_US\/i\/btn\/x-click-but02.gif","sandbox":"0","sandbox_merchant_email":"","sandbox_customer_email":"","articleid":"","display_article_title":"0","failed_order_state":"10","payment_received_order_state":"17"}');
