...
<div class="tabbable tabs-left">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#existing"><?php echo JText::_('COM_TIENDA_USE_AN_EXISTING_USER'); ?></a></li>
    <li class=""><a data-toggle="tab" href="#create"><?php echo JText::_('COM_TIENDA_CREATE_A_NEW_USER'); ?></a></li>
    <li class=""><a data-toggle="tab" href="#anonymous"><?php echo JText::_('COM_TIENDA_ANONYMOUS'); ?></a></li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane active" id="existing">
             <div class="option userOption well well-small">
                <label class="radio">
                <input type="radio" id="radioExisting" name="user_type" value="existing" <?php if ($this->session->get('user_type', '', 'tienda_pos') == 'existing' || $this->session->get('user_type', '', 'tienda_pos') == '') { ?>checked="checked" <?php } ?> /><?php echo JText::_('COM_TIENDA_USE_AN_EXISTING_USER'); ?>
     ...
     <div class="tab-pane" id="create">
            <div class="option userOption well well-small">
                <label class="radio">
                <input type="radio" id="radioCreate" name="user_type" value="new" <?php if ($this->session->get('user_type', '', 'tienda_pos') == 'new') { ?>checked="checked" <?php } ?> /><?php echo JText::_('COM_TIENDA_CREATE_A_NEW_USER'); ?>
                </label>
                ...
                <div class="option_data">
                    <input id="new_username_create" type="checkbox" name="new_username_create" value="yes" checked="checked" /><?php echo JText::_('COM_TIENDA_AUTO_CREATE_USERNAME'); ?>
     ...
     <div class="tab-pane" id="anonymous">
             <div class="option userOption well well-small">
                <label class="radio">
                <input type="radio" id="radioAnno" name="user_type" value="anonymous" <?php if ($this->session->get('user_type', '', 'tienda_pos') == 'anonymous') { ?>checked="checked" <?php } ?> /><?php echo JText::_('COM_TIENDA_ANONYMOUS'); ?>
                </label>
	...
	<div class="continue">
		...
		<input onclick="<?php echo $onclick; ?>" style="margin-bottom : 15px;" value="<?php echo JText::_('COM_TIENDA_CONTINUE_STEP1'); ?>" type="button" class="button btn btn-success" />
	</div>
</div>
