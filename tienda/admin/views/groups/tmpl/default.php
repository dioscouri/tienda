	...
	<table class="table table-striped table-bordered" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo TiendaGrid::sort( 'COM_TIENDA_ID', "tbl.group_id", @$state->direction, @$state->order ); ?>
                </th>                
                <th style="text-align: left;">
                	<?php echo TiendaGrid::sort( 'COM_TIENDA_NAME', "tbl.group_name", @$state->direction, @$state->order ); ?>
                </th>
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo TiendaGrid::checkedout( $item, $i, 'group_id' ); ?>
				</td>
				<td style="text-align: center;">
