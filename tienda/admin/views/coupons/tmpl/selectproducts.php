...
<h1 style="margin-left: 2%; margin-top: 2%;"><?php echo JText::_('COM_TIENDA_SELECT_PRODUCTS_FOR'); ?>: <?php echo $row->coupon_name; ?></h1>
    ...
    <table>
        <tr>
            ...
            <td nowrap="nowrap">
                ...
                <?php echo TiendaSelect::category( @$state->filter_category, 'filter_category', $attribs, 'filter_category', true, true ); ?>
            </td>
        </tr>
    </table>
