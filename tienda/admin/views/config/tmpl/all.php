...
<form action="<?php echo JRoute::_( @$form['action'] )?>" method="post" name="adminForm" enctype="multipart/form-data">
                    ...
                    <div class="accordion" id="accordion2">
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#shop"> <?php echo JText::_('COM_TIENDA_SHOP_INFORMATION'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#images"> <?php echo JText::_('COM_TIENDA_IMAGES_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#currency"> <?php echo JText::_('COM_TIENDA_CURRENCY_UNITS_AND_DATE_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#orders"> <?php echo JText::_('COM_TIENDA_ORDER_AND_CHECKOUT_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#display"> <?php echo JText::_('COM_TIENDA_DISPLAY_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#subscriptions"> <?php echo JText::_('COM_TIENDA_SUBSCRIPTION_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#DASHBOARD_SETTINGS"> <?php echo JText::_('COM_TIENDA_ADMINISTRATOR_DASHBOARD_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#coupons"> <?php echo JText::_('COM_TIENDA_COUPON_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#ADMINISTRATOR_TOOLTIPS"> <?php echo JText::_('COM_TIENDA_ADMINISTRATOR_TOOLTIPS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#PRODUCT_REVIEWS"> <?php echo JText::_('COM_TIENDA_PRODUCT_REVIEWS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#ADVANCED_SETTINGS"> <?php echo JText::_('COM_TIENDA_ADVANCED_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#email"> <?php echo JText::_('COM_TIENDA_EMAIL_SETTINGS'); ?>
                                </a>
                            </div>
                            <div id="email" class="accordion-body collapse" style="height: 0px;">
                                <div class="accordion-inner">
                                    <table class="table table-striped table-bordered">
                                        <tbody>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOP_EMAIL_ADDRESS'); ?><br />
                                                </th>
                                                <td><input type="text" name="shop_email" value="<?php echo $this -> row -> get('shop_email', ''); ?>" class="inputbox" size="35" />
                                                </td>
                                                <td><?php echo JText::_('COM_TIENDA_SHOP_EMAIL_ADDRESS_DESC'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOP_EMAIL_FROM_NAME'); ?><br />
                                                </th>
                                                <td><input type="text" name="shop_email_from_name" value="<?php echo $this -> row -> get('shop_email_from_name', ''); ?>" class="inputbox" size="35" />
                                                </td>
                                                <td><?php echo JText::_('COM_TIENDA_SHOP_EMAIL_FROM_NAME_DESC'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_DISABLE_GUEST_SIGNUP_EMAIL'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php  echo TiendaSelect::btbooleanlist('disable_guest_signup_email', 'class="inputbox"', $this -> row -> get('disable_guest_signup_email', '0')); ?>
                                                </td>
                                                <td><?php echo JText::_('COM_TIENDA_DISABLE_GUEST_SIGNUP_EMAIL_DESC'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_OBFUSCATE_GUEST_EMAIL'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php  echo TiendaSelect::btbooleanlist('obfuscate_guest_email', 'class="inputbox"', $this -> row -> get('obfuscate_guest_email', '0')); ?>
                                                </td>
                                                <td><?php echo JText::_('COM_TIENDA_OBFUSCATE_GUEST_EMAIL_DESC'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_ENABLE_ORDER_STATUS_UPDATE_EMAIL_TO_USER_WHEN_ORDER_PAYMENT_IS_RECEIVED'); ?>
                                                </th>
                                                <td><?php  echo TiendaSelect::btbooleanlist('autonotify_onSetOrderPaymentReceived', 'class="inputbox"', $this -> row -> get('autonotify_onSetOrderPaymentReceived', '0')); ?>
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_ADDITIONAL_EMAIL_ADDRESSES_TO_RECEIVE_ORDER_NOTIFICATIONS'); ?><br />
                                                </th>
                                                <td><textarea name="order_emails" style="width: 250px;" rows="10">
                                                        <?php echo $this -> row -> get('order_emails', ''); ?>
                                                    </textarea>
                                                </td>
                                                <td><?php echo JText::_('COM_TIENDA_ADDITIONAL_EMAIL_ADDRESSES_TO_RECEIVE_ORDER_NOTIFICATIONS_DESC'); ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#address_fields"> <?php echo JText::_('COM_TIENDA_ADDRESS_FIELDS_MANAGEMENT'); ?>
                                </a>
                            </div>
                            <div id="address_fields" class="accordion-body collapse" style="height: 0px;">
                                <div class="accordion-inner">
                                    <table class="table table-striped table-bordered">
                                        <tbody>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_ADDRESS_NAME_FIELD'); ?><br /> <small><?php echo JText::_('COM_TIENDA_CONFIG_SHOW_ADDRESS_TITLE_NOTE'); ?> </small>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_address_name', '3'), 'show_field_address_name'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_ADDRESS_NAME_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_address_name', '3'), 'validate_field_address_name'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_TITLE_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_title', '3'), 'show_field_title'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_TITLE_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_title', '3'), 'validate_field_title'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_FIRST_NAME_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_name', '3'), 'show_field_name'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_FIRST_NAME_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_name', '3'), 'validate_field_name'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_MIDDLE_NAME_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_middle', '3'), 'show_field_middle'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_MIDDLE_NAME_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_middle', '0'), 'validate_field_middle'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_LAST_NAME_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_last', '3'), 'show_field_last'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_LAST_NAME_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_last', '3'), 'validate_field_last'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_COMPANY_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_company', '3'), 'show_field_company'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_COMPANY_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_company', '0'), 'validate_field_company'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_COMPANY_TAX_NUMBER_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_tax_number', '3'), 'show_field_tax_number'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_COMPANY_TAX_NUMBER_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_tax_number', '3'), 'validate_field_tax_number'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_ADDRESS_1_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_address1', '3'), 'show_field_address1'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_ADDRESS_1_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_address1', '3'), 'validate_field_address1'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_ADDRESS_2_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_address2', '3'), 'show_field_address2'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_ADDRESS_2_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_address2', '0'), 'validate_field_address2'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_CITY_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_city', '3'), 'show_field_city'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_CITY_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_city', '3'), 'validate_field_city'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_COUNTRY_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_country', '3'), 'show_field_country'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_COUNTRY_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_country', '3'), 'validate_field_country'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_ZONE_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_zone', '3'), 'show_field_zone'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_ZONE_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_zone', '3'), 'validate_field_zone'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_POSTAL_CODE_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_zip', '3'), 'show_field_zip'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_POSTAL_CODE_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_zip', '3'), 'validate_field_zip'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_PHONE_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_phone', '3'), 'show_field_phone'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_PHONE_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_phone', '0'), 'validate_field_phone'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_CELL_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_cell', '3'), 'show_field_cell'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_CELL_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_cell', '0'), 'validate_field_cell'); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;"><?php echo JText::_('COM_TIENDA_SHOW_FAX_FIELD'); ?>
                                                </th>
                                                <td style="width: 150px;"><?php echo TiendaSelect::addressShowList($this -> row -> get('show_field_fax', '3'), 'show_field_fax'); ?>
                                                </td>
                                                <th><?php echo JText::_('COM_TIENDA_VALIDATE_FAX_FIELD'); ?>
                                                </th>
                                                <td><?php echo TiendaSelect::addressShowList($this -> row -> get('validate_field_fax', '0'), 'validate_field_fax'); ?>
                                                </td>
                                            </tr>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#product_compare"> <?php echo JText::_('COM_TIENDA_PRODUCT_COMPARE_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#low_stock_notify"> <?php echo JText::_('COM_TIENDA_LOW_STOCK_NOTIFY_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#eav_editor_settings"> <?php echo JText::_('COM_TIENDA_EAV_EDITOR_SETTINGS'); ?>
                                </a>
                            </div>
                        ...
                        <div class="accordion-group">
                            <div class="accordion-heading">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#features_settings"> <?php echo JText::_('COM_TIENDA_FEATURES_SETTINGS'); ?>
                                </a>
                            </div>
    ...
    <input type="hidden" name="task" value="" /> <input type="hidden" name="boxchecked" value="" /> <input type="hidden" name="filter_order" value="<?php echo @$state -> order; ?>" /> <input type="hidden" name="filter_direction" value="<?php echo @$state -> direction; ?>" />
