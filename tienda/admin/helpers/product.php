...
class TiendaHelperProduct extends TiendaHelperBase
{
    ...
    function getLayouts( $options = array( ) )
    {
        ...
        $folder = JPATH_SITE . '/components/com_tienda/views/products/tmpl';
    ...
    function getLayout( $product_id, $options = array( ) )
    {
        ...
        $extensionPath = JPATH_SITE .  '/components/com_tienda/views/products/tmpl/%s' . '.php';
    ...
    public static function getAttributes( $id, $parent_option = "-1" )
    {
        ...
        Tienda::load('TiendaModelProductAttributes','models.productattributes');
    ...
    function getDefaultAttributes( $id )
    {
        ...
        {   
            ...
            foreach ( $items as $item )
            {
                ...
                Tienda::load('TiendaModelProductAttributeOptions','models.productattributeoptions');
    ...
    function getFiles( $id )
    {
        ...
        Tienda::load('TiendaModelProductFiles','models.productsfiles');
    ...
    public static function getCartButton( $product_id, $layout = 'product_buy', $values = array( ) )
    {
        ...
        $view->addTemplatePath( JPATH_SITE . DS . 'components/com_tienda/views/products/tmpl' );
        $view->addTemplatePath( JPATH_SITE . DS . 'templates' . DS . JFactory::getApplication('site')->getTemplate() . DS . 'html/com_tienda/products' . DS );
        // add extra templates
