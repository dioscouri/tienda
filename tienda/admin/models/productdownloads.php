...
class TiendaModelProductDownloads extends TiendaModelBase
{
    ...
    {        
        $query->select( $this->getState( 'select', 'tbl.productdownload_id, tbl.productfile_id, '.
        																						'tbl.productdownload_max, tbl.product_id,'.
        																						'tbl_files.productfile_name as `filename`, '.
