    ...
    foreach (@$orders as $order) : ?>
        <div class="mod_tienda_my_orders_item">
            <?php if ($params->get('display_date')) { ?>
                <span class="mod_tienda_my_orders_item_date"><a href="<?php echo $order->link ?>"><?php echo JHTML::_('date', $order->created_date, Tienda::getInstance()->get('date_format')); ?></a></span><br/>
            <?php } ?>
            <?php if ($params->get('display_amount')) { ?>
                <span class="mod_tienda_my_orders_item_amount"><b><?php echo JText::_('COM_TIENDA_AMOUNT'); ?>:</b> <?php echo $currency_helper->_($order->order_total); ?></span>
            <?php } ?>
            ...
            <?php if ($params->get('display_state')) { ?>
                <span class="mod_tienda_my_orders_item_status"><b><?php echo JText::_('COM_TIENDA_STATUS'); ?>:</b> <?php echo JText::_( $order->order_state_name ); ?></span><br/>
            <?php } ?>
        </div>
        <?php  
    endforeach; 
