...
class plgTiendaPayment_paypal_express_checkout extends TiendaPaymentPlugin
{
    /**
     * @var $_element  string  Should always correspond with the plugin's filename,
     *                         forcing it to be unique
     */
    public $_element    = 'payment_paypal_express_checkout';

    public function plgTiendaPayment_paypal_express_checkout(& $subject, $config)
    {
