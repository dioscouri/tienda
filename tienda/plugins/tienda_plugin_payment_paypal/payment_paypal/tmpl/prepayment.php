    ...
    { 
        ...
        default:
            ...
            <?php if ($vars->mixed_cart) { ?>
                ...
                <div id="payment_paypal">
                    ...
                    <div class="prepayment_action">
                        ...
                        <div style="float: left; padding: 10px;"><?php echo "<b>".JText::_('COM_TIENDA_FIRST_CHECKOUT_AMOUNT').":</b> ".TiendaHelperBase::currency( @$vars->orderpayment_amount ); ?></div>
                        <div style="float: left; padding: 10px;"><?php echo "<b>".JText::_('COM_TIENDA_SECOND_CHECKOUT_AMOUNT').":</b> ".TiendaHelperBase::currency( $vars->amount ); ?></div>
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" />
                        <div style="clear: both;"></div>
                    </div>
                </div>
            <?php } else { ?>
                <div id="payment_paypal">
                    <div class="prepayment_message">
                        <?php echo JText::_('COM_TIENDA_PAYPAL_PAYMENT_STANDARD_PREPARATION_MESSAGE'); ?>
                    </div>
                    <div class="prepayment_action">
