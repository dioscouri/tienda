...
<form action="<?php echo JRoute::_( 'index.php?option=com_tienda&task=doTask&element=bug_report&elementTask=sendBug' ) ?>" method="post" class="adminform" name="adminForm" >
    ...
    <fieldset>
        <legend><?php echo JText::_('COM_TIENDA_SUBMIT_BUG'); ?></legend>
            ...
            <input class="btn" type="submit" value="<?php echo JText::_('COM_TIENDA_SEND'); ?>">
            <input type="button" class="btn" onclick="window.location = '<?php echo JRoute::_('index.php?option=com_tienda&view=dashboard'); ?>'" value="<?php echo JText::_('COM_TIENDA_CANCEL'); ?>" />
    </fieldset>
</form>