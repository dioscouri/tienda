...
<?php // echo JText::_('COM_TIENDA_THIS_REPORTS_ON_DISPLAYING_LIST_OF_USERS_WITH_ITEMS_NOT_PURCHASED'); ?>
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav navbar-form pull-left">
    	 ...
    	 <li><input type="text" name="filter_name" placeholder ="<?php echo JText::_('COM_TIENDA_USER_NAME'); ?>" id="filter_name" value="<?php echo @$state->filter_name; ?>" /></li>
