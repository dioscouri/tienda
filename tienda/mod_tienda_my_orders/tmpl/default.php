    ...
    foreach (@$orders as $order) : ?>
        <div class="mod_tienda_my_orders_item">
            ...
            <?php if ($params->get('display_amount')) { ?>
                <span class="mod_tienda_my_orders_item_amount"><b><?php echo JText::_("Amount"); ?>:</b> <?php echo Tienda::getClass( "TiendaHelperCurrency", 'helpers.currency' )->_($order->order_total); ?></span>
            <?php } ?>
